...
/* ADDING TYPE CHECKING TO THE COMPONENTS USING PROP TYPES
 
  With prop types we can basically specify the type of the value that we expect the consumer of the component to pass in for each of the 
  props , For example we can define the max rating must be a number and nothing else. This is what we called type checking. If you really 
  care about the type checking of the props then you have to use type script instead of prop types in javascript framework react
